...
import kotlinx.android.synthetic.main.fragment_fakultas_saya.*
import java.util.ArrayList

class FakultasSayaFragment : Fragment(), SwipeRefreshLayout.OnRefreshListener,
        ...
        override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            result_swipeRefresh.setOnRefreshListener(this)
        ...
        private fun fetchData() {
            ...
            val fakultas = prefs.getString("fak", "")
            val singkatanFak = FakultasConverter.getSingkatanFakultas(fakultas, context)

            compositeDisposable?.add(
                RestClient.jadwalService.getJadwalByFakultas(singkatanFak)
