...
object HasilPertandingan {
    data class KategoriResponse(var status: Boolean, var message: String, var data: List<KategoriData>)
    data class KategoriData(var ID_CABOR: String, var NAMA_CABOR: String,
                            var KATEGORI_CABOR: String, var JENIS_CABANG: String,
                            var JENIS_PERTANDINGAN: String)

    data class HasilResponse(var status: Boolean, var message: String, var data: List<HasilData>)
    data class HasilData(var ID_JADWAL: String, var NAMA_JADWAL : String,
                         var ID_FAKULTAS: String, var NAMA_FAKULTAS: String,
                         var NAMA_CABOR: String, var KATEGORI_CABOR: String,
                         var JENIS_PERTANDINGAN: String, var WAKTU: String,
                         var VENUE: String, var HASIL: String,
